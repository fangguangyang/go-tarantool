...
[tarantool/go-tarantool](github.com/fangguangyang/go-tarantool) repository.
To download and install, say:

```
$ go get github.com/fangguangyang/go-tarantool
```

This should bring source and binary files into subdirectories of `/usr/local/go`,
making it possible to access by adding `github.com/fangguangyang/go-tarantool` in
...
* [connection.go](https://github.com/fangguangyang/go-tarantool/blob/master/connection.go)
  for the `Connect()` function plus functions related to connecting, and
* [request.go](https://github.com/fangguangyang/go-tarantool/blob/master/request.go)
...
[errors.go](https://github.com/fangguangyang/go-tarantool/blob/master/errors.go),
...
**Observation 1:** the line "`github.com/fangguangyang/go-tarantool`" in the
...
[tarantool/go-tarantool](http://github.com/fangguangyang/go-tarantool/issues).
