...
func (k IntIntKey) EncodeMsgpack(enc *msgpack.Encoder) error {
	...
	enc.EncodeInt64(int64(k.I1))
	enc.EncodeInt64(int64(k.I2))
	return nil
}
...
func (o OpSplice) EncodeMsgpack(enc *msgpack.Encoder) error {
	...
	enc.EncodeString(o.Op)
	enc.EncodeInt64(int64(o.Field))
	enc.EncodeInt64(int64(o.Pos))
	enc.EncodeInt64(int64(o.Len))
